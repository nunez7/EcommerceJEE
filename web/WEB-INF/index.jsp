...
<head>
    ...
    <title>Inicio <%=session.getAttribute("moneda").toString()%> |  Crea e-Commerce JAVA EE con pagos Online Paypal y Payu</title>
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Productos destacados</h2>
                                                ...
                                                <%
                                                    ...
                                                    }if(Integer.parseInt(session.getAttribute("brand").toString())>0){
										...
										<li><a href=""><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></a></li>
                                                                                <li><a href="#" <c:if test="${p.stock==0}">class="gris"</c:if>>
                                                                                    <c:choose>
                                                                                        ...
                                                                                        <c:otherwise>
                                                                                            <i class="fa fa-lock"></i>(<c:out value="${p.stock}"></c:out>) Agotado
                                                                                        </c:otherwise>   
                                                                                    </c:choose> 
                                                                                </a>
                                                                        </li>
