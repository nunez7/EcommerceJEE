				...
				<table class="table table-condensed">
					...
					<tbody>
                                            <c:forEach var="pro" items="${sessionScope.cart}">
                                                <c:set var="total" value="${total+pro.p.precio*pro.cantidad}"></c:set>
                                                <tr>
							<td class="cart_product">
                                                            <a href=""><img src="foto/${pro.p.imagen}" width="110px" alt=""></a>
							</td>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
                                                                        <a class="cart_quantity_down" href="?action=min&id=${pro.p.webId}"> - </a>
									<input class="cart_quantity_input" type="text" name="quantity" value="${pro.cantidad}" autocomplete="off" size="2">
									<a class="cart_quantity_up" href="?action=plus&id=${pro.p.webId}"> + </a>
								</div>
							</td>
							<td class="cart_total">
				...
				<div class="col-sm-10">
					<div class="total_area">
						<ul>
							...
							<li>Tax/IVA(16%) <span>$${total*.16}</span></li>
                                                        <li><h3>Total <span>$${total+(total*.16)}</span></h3></li>
						</ul>
